...
<div style="font-size: 12px;">
    W: {left_wickets}{spacer}{spacer}{spacer}{spacer}{spacer}W: {right_wickets}<br>
    Avg: {left_ba}{spacer}{spacer}{spacer}{spacer}Avg: {right_ba}<br>
    SR: {left_sr}{spacer}{spacer}{spacer}{spacer}SR: {right_sr}
</div>
"""
